        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {organizations.map((org) => (
            <Link
              ...
              className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow focus:outline-none focus:ring-2 focus:ring-blue-500"
...
const NotFound: React.FC = () => {
  return (
    <div className="text-center py-20">
      ...
      <Link to="/" className="text-blue-600 hover:underline focus:outline-none focus:ring-2 focus:ring-blue-500">
        Return to Home
      </Link>
    </div>
  );
